...
# python chunk_parser_main.py -IOB -train $train_file $sent_parser
# python chunk_parser_main.py -IOB -test $test_file $sent_parser $IOB_output


# parse chunk
python chunk_parser_main.py -chunk -train $train_file $chunk_parser $sent_parser 
python chunk_parser_main.py -chunk -test $test_file $chunk_parser $sent_parser $chunk_output $factor


# parse clause
python chunk_parser_main.py -clause -train $train_file $clause_parser $sent_parser 
python chunk_parser_main.py -clause -test $test_file $clause_parser $sent_parser $clause_output $factor
